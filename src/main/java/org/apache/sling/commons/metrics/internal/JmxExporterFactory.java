...
public class JmxExporterFactory {
    ...
    public @interface Config {
        ...
        @AttributeDefinition(
                name = "objectnames",
                description =
                        "export all attribute of the MBeans matching these objectnames as Sling Metrics"
            ...
            if (MBeanServerNotification.REGISTRATION_NOTIFICATION.equals(notification.getType())) {
                ...
                try {
                    if (notification instanceof MBeanServerNotification) {
                        ...
                        LOG.debug(
                                "JMX Notification : Cannot handle notification, because it's not a MBeanServerNotification ({})",
                                notification);
                    }
    ...
    protected void registerMBeanProperties(ObjectName objectname)
            throws InstanceNotFoundException, ReflectionException, IntrospectionException {
        ...
        for (MBeanAttributeInfo attr : attributes) {
            ...
            if (supplier != null) {
                ...
                LOG.info(
                        "Registering metric {} from MBean (objectname=[{}], name={}, type={})",
                        metricName,
                        objectname,
                        attr.getName(),
                        attr.getType());
    ...
    private <T> Supplier<T> getSupplier(ObjectName name, String attributeName, T defaultValue) {
        ...
        return () -> {
            try {
                ...
                LOG.warn(
                        "error when retrieving value for MBean (objectname=[{}], attribute={})",
                        name,
                        attributeName,
                        e);
                return defaultValue;
